...
import SelectConnector from './components/select_connecor'
...
import websoket from './websocket'
    ...
    render () {
        ...
        return (
            <div>
                ...
                <SideBar idContainer="mainContainer" store={store} loggedInJadge={this.state.loggedInJadge}/>
